...
INSERT INTO voting (menu_id, restaurant_id  , user_id) VALUES
  (100015, 100002, 100000),
  (100015, 100002, 100001),
  (100016, 100002, 100000),
  (100016, 100002, 100001),
  (100017, 100002, 100000),
  (100017, 100002, 100001),
  (100018, 100003, 100000),
  (100018, 100003, 100001),
  (100019, 100003, 100000),
  (100019, 100003, 100001),
  (100020, 100003, 100000),
  (100020, 100003, 100001);
